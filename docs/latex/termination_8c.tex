\hypertarget{termination_8c}{}\section{/home/ben/\+Documents/\+Projects/\+Q\+P\+A\+L\+M/src/termination.c File Reference}
\label{termination_8c}\index{/home/ben/Documents/Projects/QPALM/src/termination.c@{/home/ben/Documents/Projects/QPALM/src/termination.c}}


Routines to check the termination and infeasibility criteria.  


{\ttfamily \#include \char`\"{}termination.\+h\char`\"{}}\newline
...
\item 
\mbox{\hyperlink{global__opts_8h_aa3217a0f49d3e52b74e9dd830c44472f}{c\+\_\+int}} \mbox{\hyperlink{termination_8c_a77bf8ca55a3eab6356c7624c500b02e4}{check\+\_\+termination}} (\mbox{\hyperlink{structQPALMWorkspace}{Q\+P\+A\+L\+M\+Workspace}} $\ast$work)
...
void \mbox{\hyperlink{termination_8c_a248d97a7a68e015a999e06d40017dabe}{calculate\+\_\+residuals\+\_\+and\+\_\+tolerances}} (\mbox{\hyperlink{structQPALMWorkspace}{Q\+P\+A\+L\+M\+Workspace}} $\ast$work)
\begin{DoxyCompactList}\small\item\em Calls the primal and dual residual and tolerance routines. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{termination_8c_afc13c2c286796ec381cdb5c83d9f764f}{calculate\+\_\+primal\+\_\+residual}} (\mbox{\hyperlink{structQPALMWorkspace}{Q\+P\+A\+L\+M\+Workspace}} $\ast$work)
...
void \mbox{\hyperlink{termination_8c_a755facb8a07f865bd114215133d6c089}{calculate\+\_\+dual\+\_\+residual}} (\mbox{\hyperlink{structQPALMWorkspace}{Q\+P\+A\+L\+M\+Workspace}} $\ast$work)
...
void \mbox{\hyperlink{termination_8c_ac638a8fe12bfee736c6832fa6140c92d}{calculate\+\_\+primal\+\_\+tolerance}} (\mbox{\hyperlink{structQPALMWorkspace}{Q\+P\+A\+L\+M\+Workspace}} $\ast$work)
...
void \mbox{\hyperlink{termination_8c_ad746ec6ec47a1240e5e910abfb01fee3}{calculate\+\_\+dual\+\_\+tolerances}} (\mbox{\hyperlink{structQPALMWorkspace}{Q\+P\+A\+L\+M\+Workspace}} $\ast$work)
...
\mbox{\hyperlink{global__opts_8h_aa3217a0f49d3e52b74e9dd830c44472f}{c\+\_\+int}} \mbox{\hyperlink{termination_8c_a6dbbbcff619e13f4164f7248365cfec0}{is\+\_\+solved}} (\mbox{\hyperlink{structQPALMWorkspace}{Q\+P\+A\+L\+M\+Workspace}} $\ast$work)
...
\mbox{\hyperlink{global__opts_8h_aa3217a0f49d3e52b74e9dd830c44472f}{c\+\_\+int}} \mbox{\hyperlink{termination_8c_a4df388b37067a843cbb2c6b244496d9c}{is\+\_\+primal\+\_\+infeasible}} (\mbox{\hyperlink{structQPALMWorkspace}{Q\+P\+A\+L\+M\+Workspace}} $\ast$work)
\begin{DoxyCompactList}\small\item\em Check whether the problem is primal infeasible. \end{DoxyCompactList}\item 
\mbox{\hyperlink{global__opts_8h_aa3217a0f49d3e52b74e9dd830c44472f}{c\+\_\+int}} \mbox{\hyperlink{termination_8c_a8cf01c07469436e7c562c9f3e162fd2b}{is\+\_\+dual\+\_\+infeasible}} (\mbox{\hyperlink{structQPALMWorkspace}{Q\+P\+A\+L\+M\+Workspace}} $\ast$work)
\begin{DoxyCompactList}\small\item\em Check whether the problem is dual infeasible. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{termination_8c_a59f3d4d2ea459665833cc3d5e9265d5e}{store\+\_\+solution}} (\mbox{\hyperlink{structQPALMWorkspace}{Q\+P\+A\+L\+M\+Workspace}} $\ast$work)
\item 
\mbox{\hyperlink{global__opts_8h_aa3217a0f49d3e52b74e9dd830c44472f}{c\+\_\+int}} \mbox{\hyperlink{termination_8c_aa1d7800c435fff9310d684b4154e7fdb}{check\+\_\+subproblem\+\_\+termination}} (\mbox{\hyperlink{structQPALMWorkspace}{Q\+P\+A\+L\+M\+Workspace}} $\ast$work)
...
\mbox{\Hypertarget{termination_8c_a755facb8a07f865bd114215133d6c089}\label{termination_8c_a755facb8a07f865bd114215133d6c089}} 
\index{termination.c@{termination.c}!calculate\_dual\_residual@{calculate\_dual\_residual}}
\index{calculate\_dual\_residual@{calculate\_dual\_residual}!termination.c@{termination.c}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{termination_8c_ad746ec6ec47a1240e5e910abfb01fee3}\label{termination_8c_ad746ec6ec47a1240e5e910abfb01fee3}} 
\index{termination.c@{termination.c}!calculate\_dual\_tolerances@{calculate\_dual\_tolerances}}
\index{calculate\_dual\_tolerances@{calculate\_dual\_tolerances}!termination.c@{termination.c}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{termination_8c_afc13c2c286796ec381cdb5c83d9f764f}\label{termination_8c_afc13c2c286796ec381cdb5c83d9f764f}} 
\index{termination.c@{termination.c}!calculate\_primal\_residual@{calculate\_primal\_residual}}
\index{calculate\_primal\_residual@{calculate\_primal\_residual}!termination.c@{termination.c}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{termination_8c_ac638a8fe12bfee736c6832fa6140c92d}\label{termination_8c_ac638a8fe12bfee736c6832fa6140c92d}} 
\index{termination.c@{termination.c}!calculate\_primal\_tolerance@{calculate\_primal\_tolerance}}
\index{calculate\_primal\_tolerance@{calculate\_primal\_tolerance}!termination.c@{termination.c}}
...
\hline
\end{DoxyParams}
NB Implementation detail\+: store Einv$\ast$\+Ax and Einv$\ast$z in temp\+\_\+2m. The infinity norm of that vector is equal to the maximum of the infinity norms of Einv$\ast$\+Ax and Einv$\ast$z. \mbox{\Hypertarget{termination_8c_a248d97a7a68e015a999e06d40017dabe}\label{termination_8c_a248d97a7a68e015a999e06d40017dabe}} 
\index{termination.c@{termination.c}!calculate\_residuals\_and\_tolerances@{calculate\_residuals\_and\_tolerances}}
\index{calculate\_residuals\_and\_tolerances@{calculate\_residuals\_and\_tolerances}!termination.c@{termination.c}}
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{termination_8c_aa1d7800c435fff9310d684b4154e7fdb}\label{termination_8c_aa1d7800c435fff9310d684b4154e7fdb}} 
\index{termination.c@{termination.c}!check\_subproblem\_termination@{check\_subproblem\_termination}}
\index{check\_subproblem\_termination@{check\_subproblem\_termination}!termination.c@{termination.c}}
\subsubsection{\texorpdfstring{check\_subproblem\_termination()}{check\_subproblem\_termination()}}
{\footnotesize\ttfamily \mbox{\hyperlink{global__opts_8h_aa3217a0f49d3e52b74e9dd830c44472f}{c\+\_\+int}} check\+\_\+subproblem\+\_\+termination (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structQPALMWorkspace}{Q\+P\+A\+L\+M\+Workspace}} $\ast$}]{work }\end{DoxyParamCaption})}

\mbox{\Hypertarget{termination_8c_a77bf8ca55a3eab6356c7624c500b02e4}\label{termination_8c_a77bf8ca55a3eab6356c7624c500b02e4}} 
\index{termination.c@{termination.c}!check\_termination@{check\_termination}}
\index{check\_termination@{check\_termination}!termination.c@{termination.c}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{termination_8c_a8cf01c07469436e7c562c9f3e162fd2b}\label{termination_8c_a8cf01c07469436e7c562c9f3e162fd2b}} 
\index{termination.c@{termination.c}!is\_dual\_infeasible@{is\_dual\_infeasible}}
\index{is\_dual\_infeasible@{is\_dual\_infeasible}!termination.c@{termination.c}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{termination_8c_a4df388b37067a843cbb2c6b244496d9c}\label{termination_8c_a4df388b37067a843cbb2c6b244496d9c}} 
\index{termination.c@{termination.c}!is\_primal\_infeasible@{is\_primal\_infeasible}}
\index{is\_primal\_infeasible@{is\_primal\_infeasible}!termination.c@{termination.c}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{termination_8c_a6dbbbcff619e13f4164f7248365cfec0}\label{termination_8c_a6dbbbcff619e13f4164f7248365cfec0}} 
\index{termination.c@{termination.c}!is\_solved@{is\_solved}}
\index{is\_solved@{is\_solved}!termination.c@{termination.c}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{termination_8c_a59f3d4d2ea459665833cc3d5e9265d5e}\label{termination_8c_a59f3d4d2ea459665833cc3d5e9265d5e}} 
\index{termination.c@{termination.c}!store\_solution@{store\_solution}}
\index{store\_solution@{store\_solution}!termination.c@{termination.c}}
\subsubsection{\texorpdfstring{store\_solution()}{store\_solution()}}
{\footnotesize\ttfamily void store\+\_\+solution (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structQPALMWorkspace}{Q\+P\+A\+L\+M\+Workspace}} $\ast$}]{work }\end{DoxyParamCaption})}
