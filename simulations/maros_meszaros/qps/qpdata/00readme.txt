his file is 00readme.txt describing an available set of convex quadratic
programming (QP) problems. For the full description see:

MAROS I.- MESZAROS CS.: A repository of convex quadratic programming problems.
          Optimization Methods and Software,  11&12:671-681, (1999)
...
different structure:  http://www.sztaki.hu/~meszaros/public_ftp/qpdata is a
public accessible site with three subdirectories corresponding to the above three zip
files.  Here, the subdirectories contain individual zip files of the
problems.
...
selfqmin     960   21920 3070807   20000        0   -1.9199961e-01
...
Christos Siopis (University of Florida, USA):
selfqmin
